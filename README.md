...
## Задание 3 - Промпт для генерации презентации

Был написан промпт, в котором указывается инструкция для нейросети(что нужно сделать), затем указываются основные пункты, которые необходимо указать, даются инструкции к анализу материала и составлению выводов. В случае, если нейросеть не способна сгенерировать презентацию дается указание на написание "сценария" презентации с рекомендациями по оформлению

```
Создай презентацию в формате PowerPoint (или PDF, если PPT невозможен) на тему:
«Правила проведения маневровых работ на железнодорожной станции: анализ по видеосюжету “Фитиль №183-02. Порожняк” (1969 г.)»

В презентацию необходимо включить следующие данные:
Дата создания фильма, кратко изложенный основной сюжет, мысли, которые пытался донести автор в контексте времени создания видеосюжета.

Проанализируй сюжет фильма и на основе анализа сформируй: актуальность темы, затрагиваемой в фильме и список правил проведения маневренных работ на железнодорожной станции, которые можно применить чтобы избежать повторения ситуаций в видеосюжете.

Включи актуальность и эти правила в несколько слайдов презентации.

На основе предыдущих фактов сформулируй вывод и краткую выжимку правил проведения маневренных работ на железнодорожной станции.

Включи этот вывод в слайды

Оформи слайды в строгом формате для понимания широкой аудитории, используй изображения, подходящие под слайды

В случае, если не можешь сгенерировать файл с презентацией предоставь подробное описание слайдов, заголовки и текст, который необходимо разместить на них, при возможности сгенерируй картинки, которые можно использовать. 

Дай дополнительные рекомендации, как оформить и улучшить слайды
```

Результаты работы промпта:
GigaChat

https://giga.chat/link/gcsLGabDBq Не умеет создавать файлы, поэтому предоставил план презентации с рекомендациями по оформлению, презентация имеет все ключевые пункты в себе

ChatGpt

https://chatgpt.com/share/67fc25f0-22b8-800a-9406-be6bbdb16bef Изначально составил план презентации, но затем сам предложил создать файл с ней. Презентация получилась достаточно подробной и все ключевые моменты были учтены.

DeepSeek

Нельзя поделиться чатом, но модель не может генерировать файлы, поэтому была получена схема презентации в текстовом описании. Текстовое описание подробно, включает основные моменты и использует основной сюжет картины.

По итогу для меня этот промпт сработал лучше, чем его более ранние версии. Модели улавливают контекст и форматируют свою презентацию по требованию. В некоторых случаях презентацию можно не дополнять, ее хватит на выступление до 10 минут. Можно добавить генерацию текста для выступления по презентации следующим запросом.
