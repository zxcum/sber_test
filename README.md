...
https://giga.chat/link/gcsLGabDBq

ChatGpt

DeepSeek

Нельзя поделиться чатом, но модель не может генерировать файлы, поэтому была получена схема презентации в текстовом описании
